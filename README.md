...
Der Bot kann auf jede Nachricht (egal ob du tippst oder eine Sprachnachricht schickst) zusätzlich zur Textantwort auch mit einer **eigenen Sprachnachricht** antworten. Das braucht einen kleinen kostenpflichtigen Zusatzdienst (ElevenLabs), weil die kostenlose Cloudflare-KI leider kein Deutsch spricht — die Kosten sind aber sehr gering (Bruchteile eines Cents pro Antwort). Das gilt für dich genauso wie für jeden anderen freigeschalteten Nutzer — alle teilen sich dasselbe ElevenLabs-Kontingent. Schlägt die Sprachantwort bei jemand anderem fehl (z. B. weil das monatliche Kontingent aufgebraucht ist), bekommst du als Besitzer automatisch eine Warnung darüber, die eigentliche Textantwort kommt trotzdem immer an.
